...
//  DataStructures
//
//  Created by Kilpack, Jeran on 4/17/18.
...
BinaryTreeNode<Type> * AVLLTree<Type> :: removeNode(BinaryTreeNode<Type> * parent, Type inserted)
{
    if(parent == nullptr)
    {
        return parent;
    ...
    else
    {
        ...
        else
        {
            ...
            paretn->setRightChild(removeNode(parent->getRightNode(), leftMost->getNodeData()));
        }
    }
