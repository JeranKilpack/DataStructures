...
//  DataStructures
//
//  Created by Kilpack, Jeran on 5/21/18.
...
void LinkedListTester :: testListBasics()
{
    ...
    cout << numbers.getEnd()->getData() << " Is at the end of the list and hsould be 32567"<< endl;
}
...
void LinkedListTester :: testListWithData()
{
    ...
    LinkedList<CrimeData> crimes = FileController :: readDataToList("/Users/jkil3536/Documents/Data Structures/DataStructures/DataStructures/Data/crime.csv");
    listTimer.stopTimer();
    ...
    listTimer.resetTimer();
    cout << "Here is how long it takes to acess a random data value" << endl;
    listTimer.startTimer();
    int randomLocation = (rand() * rand()) % crimes.getSize();
    cout << "The ranomd index is " << randomLocation << endl;
