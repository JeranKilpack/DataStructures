...
//  DataStructures
//
//  Created by Kilpack, Jeran on 5/29/18.
...
void GraphTester:: compareTraversals()
{
    ...
    puzzle.breadthFirstTraversal(puzzle, number);
    puzzle.breadthFirstTraversal(puzzle, numbers);
...
void GraphTester :: findCheapestTraversal()
{
    ...
    {
        cout << j << ". " << puzzle.costTraversal(puzzle, j) << endl;
        puzzle.breadthFirstTraversal(puzzle, j);
    }
}
